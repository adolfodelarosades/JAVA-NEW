...
Figura 11.5 La sintaxis de la box-shadowpropiedad
...
Figura 11.6 La sintaxis de la border-radiuspropiedad
...
<cabeza>
    ...
    <title>Diseño del libro Cover Me</title>
</cabeza>
<cuerpo>
    <header>                                                               ③ 
        <img src="images/logo.png"                                         ③ 
             alt="Diseño del logotipo de Cover Me Book">                              ④③ 
        <h1>Diseño del logotipo de Cover Me Book</h1>                                      ⑤③ 
    </header>                                                              ③
  
    <principal>
        <h1>Mis últimos diseños de libros</h1>                                    ⑥ 
        <div class="portfolio">                                            ⑦ 
                                                                          ⑦ 
            <div class="card">                                             ⑧⑦ 
                <img src="images/portfolio01.jpg"                          ⑨⑧⑦ 
                     alt="Me enamoré de ChatGPT"                     ⑧⑦ 
                     class="card-image">                                   ⑧⑦ 
                <h2>Me enamoré de ChatGPT</h2>                       ⑩⑧⑦ 
                <p>Diseñé este libro para la nueva         línea ⑪⑧⑦ 
                    de libros románticos con temática de IA de Moughton-Hifflin.                       ⑪⑧⑦ 
                </p>                                                       ⑧⑦ 
            </div>                                                         ⑧⑦ 
                                                                          ⑦ 
            <div class="card">                                             ⑦ 
                <img src=»images/portfolio02.jpg»                          ⑦ 
                     alt="La máquina del tiempo de Shakespeare"                    ⑦ 
                     class="card-image">                                   ⑦ 
                <h2>La máquina del tiempo de Shakespeare</h2>                      ⑦ 
                <p>Maggie O'Farrell conoce a HG Wells en este libro de ficción histórica    ⑦ 
                    que diseñé para Juxtaposition Publishing. ⑦ 
                </p>                                                       ⑦ 
            </div>                                                         ⑦ 
                                                                          ⑦ 
            <div class="card">                                             ⑦ 
                <img src=»images/portfolio03.jpg»                          ⑦ 
                     alt="Nuestros nuevos señores supremos de los ChatBot"                       ⑦ 
                     class="card-image">                                   ⑦ 
                <h2>Nuestros nuevos señores supremos de los ChatBot</h2>                         ⑦ 
                <p>Un futuro distópico de IA nos espera a todos en este título de ciencia     ficción 
                    que diseñé para HJ Simpson Press.     ⑦ 
                </p>                                                       ⑦ 
            </div>                                                        ⑦ 
                                                                          ⑦ 
            <div class="card">                                             ⑦ 
                <img src=»images/portfolio04.jpg»                          ⑦ 
                     ...
                     class="card-image">                                   ⑦ 
                <h2>¡Hola, Yossarian!»                                    ⑦ 
                <p>Una biografía del personaje John Yossarian de        la 
                    novela Catch-22 de Joseph Heller, diseñada para           Hyperbole 
                    Editions.                                    ⑦ 
                </p>                                                       ⑦ 
            </div>                                                         ⑦ 
                                                                          ⑦ 
            <div class="card">                                             ⑦ 
                <img src=»images/portfolio05.jpg»                          ⑦ 
                     alt="El misterio del calcetín perdido"                 ⑦ 
                     class="card-image">                                   ⑦ 
                <h2>El misterio del calcetín perdido</h2>                   ⑦ 
                <p>Un misterio perenne se resuelve en esta novela policíaca,       ⑦ 
                    que diseñé para The Butler Did It Publications.   ⑦ 
                </p>                                                       ⑦ 
            </div>                                                         ⑦ 
                                                                          ⑦ 
            <div class="card">                                             ⑦ 
                <img src=»images/portfolio06.jpg»                          ⑦ 
                     alt="Guía de TikTok para personas mayores"                ⑦ 
                     class="card-image">                                   ⑦ 
                <h2>Guía de TikTok para personas mayores</h2>                  ⑦ 
                <p>Diseñé la portada de esta guía práctica de TikTok para    ⑦ 
...
@import url('https://fonts.googleapis.com/css2?]familia=Nunito&familia=Poppins&display=swap');       ①
 
cuerpo {
    color de fondo: crema menta;                   ② 
    margen: 0;                                     ② 
    tamaño de fuente: 20px;                               ② 
    familia de fuentes: 'Nunito', sans-serif;             ②
}
...
.tarjeta {
    ancho mínimo: 200px;                              ⑨ 
    ancho máximo: 350px;                              ⑨ 
    sombra de caja: 8px 8px 4px rgba(0, 0, 0, 0.3);    ⑩ 
...
<principal>
    <h1>Mis últimos diseños de libros</h1>
    <p>
        Escriba aquí el texto de su párrafo introductorio.
    <p>
    <div class="cartera">
    etc.
...
.tarjeta {
    ancho mínimo: 200px;
    ancho máximo: 350px;
    caja-sombra: 8px 8px 4px rgba(0, 0, 0, 0.3);
    radio del borde: 20px;
    desbordamiento: oculto;
}
