...
El capítulo 11 le presenta uno de los patrones de páginas web más populares: la tarjeta, que puede utilizar para mostrar elementos como obras de arte, pasatiempos, personas o eventos. Puede aprovechar este conocimiento sobre tarjetas al obtener ChatGPT para ayudarlo a crear el proyecto de este capítulo: una página de portafolio.
