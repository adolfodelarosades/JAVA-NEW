...
Bienvenido a Java para Programadores con IA Generativa, Quinta Edición . En este prefacio, presentamos el alma del libro. El tema clave de esta edición es el apalancamiento . Aprenderás programación Java de forma más rápida, amplia y profunda con tres de las últimas metodologías pedagógicas complementarias. Harás cosas más efectivas que con enfoques de aprendizaje anteriores y estarás mejor preparado para afrontar los retos de programación y desarrollo de software que encontrarás en tu carrera profesional.

Potente: Usamos código para enseñar a programar. Aprenderás con nuestro enfoque tradicional de código en vivo . Aprovecharás tu experiencia de aprendizaje y dominarás los fundamentos de Java al sumergirte en cientos de ejemplos de código completos y funcionales con resultados significativos.

Más potente: Usamos objetos para enseñar objetos. Como novedad en esta edición, usarás nuestro enfoque basado en objetos para aprender programación orientada a objetos en Java. Aprovecharás tu capacidad para escribir programas más significativos utilizando clases preexistentes y altamente funcionales de las extensas bibliotecas de Java y otras bibliotecas de código abierto en repositorios como github.com.

Lo más potente: Usamos IA generativa para enseñar IA generativa. Como novedad en esta edición, dominarás genAI , el conjunto clave de tecnologías de inteligencia artificial que potencian tu creatividad. En los ejemplos y ejercicios de genAI, usarás indicaciones y crearás programas que producen texto original, código Java, imágenes, audio, voz, música e incluso vídeo.
...
En este libro, ofrecemos una introducción amigable, contemporánea, intensiva en código y orientada a estudios de casos de Java, uno de los lenguajes de programación más populares del mundo. 3 , 4 Java es popular para una amplia gama de aplicaciones porque es independiente de la plataforma, robusto y tieneAmplia compatibilidad con bibliotecas de clases estándar y de terceros. Se utiliza para desarrollar software para todo tipo de aplicaciones, desde los dispositivos más pequeños del Internet de las Cosas (IoT) (como sensores conectados a internet en todo el mundo) hasta las plataformas de computación empresarial en la nube más grandes. Algunos usos interesantes de Java incluyen: 5
...
4 . Índice Tiobe para enero de 2025. Consultado el 18 de enero de 2025. https://www.tiobe.com/tiobe-index/.
...
20. Deitel, Paul y Harvey Deitel. Introducción a Python para la informática y la ciencia de datos: Aprendiendo a programar con IA, Big Data y la nube . Upper Saddle River, NJ: Pearson, 2020.
...
Código Java con API de IA e ingeniería rápida: El capítulo 19 combina la ingeniería rápida y el desarrollo de código basado en API, destacando cómo genAI puede ayudarle a crear y optimizar aplicaciones Java completas. Utilizamos las API de OpenAI.
...
Descubra lo que pueden hacer los genAI probando muchas indicaciones.
...
Casos prácticos de la aplicación Java GenAI, completa, de código en vivo y basada en API del capítulo 19
...
Ejercicios de indicaciones de GenAI
...
Aplicaciones textuales: Procesamiento de documentos (indexación, resumen, exploración). Escritura creativa (generación de relatos, poesía, debates). Herramientas lingüísticas.(traducción, corrección de tono). Creación de documentos profesionales (currículums, presentaciones). Resultados estructurados.
...
Cobertura flexible de JShell , el entorno REPL (lectura-evaluación-impresión-bucle) de línea de comandos amigable de Java para explorar, descubrir y experimentar rápidamente con las características y bibliotecas del lenguaje Java : es como tener la interactividad de Python en Java .
...
28. “Recomendaciones curriculares”. Consultado el 18 de enero de 2025.https://www.acm.org/education/curricula-recommendations.
...
(Opcional) El Capítulo 22 , Recursión y Big O , se puede cubrir aquí.
...
34 . “¿Qué es el código abierto?” Consultado el 18 de enero de 2025 https://opensource.com/resources/what-open-source.
...
Un agradecimiento especial a Robert Field
...
Paul J. Deitel , CEO y Director Técnico de Deitel & Associates, Inc., es graduado del MIT con más de 44 años de experiencia en informática. Cuenta con las certificaciones de Programador Certificado Java y Desarrollador Certificado Java, y es Oracle Java Champion. Es uno de los instructores de lenguajes de programación con mayor experiencia a nivel mundial, habiendo impartido cientos de cursos profesionales a desarrolladores de software desde 1992. Sus cursos de video y formación en vivo en plataformas como O'Reilly Online Learning han generado millones de minutos de contacto, y sus cursos de video sobre Fundamentos de Java, Fundamentos de Python y Fundamentos de C# han sido número uno durante varios años entre miles de productos de video. Ha impartido cursos de programación a clientes académicos, industriales, gubernamentales y militares de Deitel & Associates, Inc. a nivel internacional, incluyendo UCLA, SLB (anteriormente Schlumberger), IBM, Siemens, Sun Microsystems (ahora Oracle), Dell, Fidelity, la NASA en el Centro Espacial Kennedy, el Laboratorio Nacional de Tormentas Severas, el Campo de Misiles White Sands, Rogue Wave Software, Boeing, Cisco, Puma, iRobot y muchos más. Él y su coautor, el Dr. Harvey M. Deitel, se encuentran entre los autores de libros de texto, libros profesionales, vídeos y multimedia interactiva sobre lenguajes de programación más vendidos del mundo.

El Dr. Harvey M. Deitel , presidente y director de estrategia de Deitel & Associates, Inc., es reconocido como un líder de pensamiento e innovador en la educación de lenguajes de programación. Tiene más de 64 años de experiencia en informática. El Dr. Deitel obtuvo títulos de licenciatura y maestría en Ingeniería Eléctrica del MIT y un doctorado en Matemáticas de la Universidad de Boston; estudió informática en cada uno de estos programas antes de que escindieran los programas de Ciencias de la Computación. Tiene una amplia experiencia como docente universitario, que incluye la obtención de la titularidad y el desempeño de la presidencia del Departamento de Ciencias de la Computación en Boston College antes de fundar Deitel & Associates en 1991 con su hijo, Paul. Las publicaciones de los Deitel han obtenido reconocimiento internacional, con más de 100 traducciones publicadas en japonés, alemán, ruso, español, francés, polaco, italiano, chino simplificado, chino tradicional, coreano, portugués, griego, urdu y turco. El Dr. Deitel ha impartido cientos de cursos de programación a clientes académicos, corporativos, gubernamentales y militares.

Acerca de Deitel ® & Associates, Inc.
Deitel & Associates, Inc., fundada por Paul Deitel y Harvey Deitel, es una organización de autoría y capacitación corporativa reconocida internacionalmente, especializada en lenguajes de programación, tecnología de objetos, desarrollo de aplicaciones móviles, tecnología de software para internet y la web, e inteligencia artificial generativa. Entre sus clientes de capacitación se incluyen algunas de las empresas más grandes del mundo, agencias gubernamentales, ramas de las fuerzas armadas e instituciones académicas. La compañía ofrece cursos de capacitación impartidos presencialmente en las instalaciones de sus clientes en todo el mundo y virtualmente en todo el mundo para Pearson.

A través de su asociación editorial de cinco décadas con Pearson, Deitel & Associates, Inc. publica libros de texto universitarios y libros profesionales de programación informática de vanguardia en formatos impresos y digitales, cursos de video, cursos de capacitación en vivo de O'Reilly Online Learning y cursos universitarios multimedia interactivos Pearson+ eText y Revel.

Para comunicarse con Deitel & Associates, Inc. y los autores o para solicitar una propuesta de capacitación virtual o presencial dirigida por un instructor en todo el mundo, escriba a

deitel@deitel.com
Para obtener más información sobre la capacitación corporativa de Deitel, visite

https://deitel.com/training
Las personas que deseen comprar publicaciones impresas y digitales de Deitel en línea pueden hacerlo en

https://amazon.com
https://barnesandnoble.com/
Para acceder fácilmente a las actualizaciones y correcciones a medida que estén disponibles, registre su copia de Java para Programadores con IA Generativa, 5.ª edición , en el sitio web InformIT de Pearson. Para iniciar el proceso de registro, visite

https://informit.com/register
Inicie sesión o cree una cuenta. Ingrese el ISBN del producto ( 9780137574735) y haga clic en Enviar .

Los libros electrónicos de Deitel están disponibles en varios formatos desde
...
https://informit.com/
Para registrarse para una prueba gratuita de 10 días de O'Reilly Online Learning, visite
